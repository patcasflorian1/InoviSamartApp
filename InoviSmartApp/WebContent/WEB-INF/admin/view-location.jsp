            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <h6>Date <c:out value="${model.europeDateTime }"></c:out></h6>
                  ...
                  title="EditLocation"  href="#EditLocation" id="view-source" >
...
<td><c:out value="${getLocation.interfaceParam.pollutionGases}"></c:out></td>
      ...
      <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
						<form style="text-align: center;" action="list-paramLocation.htm">
	...
	<script>
		...
		//Obține valorile din modelul returnat de controller
		 ...
		 var yValues = [<c:forEach items="${paramDataList}" var="parametre">
