...
public class LoginController {
	...
	public static boolean getLoginAdmin() {
			return isLoginAdmin;
		}
		
		
		public static  void setLoginAdmin(boolean isLoginrAdmin) {
			LoginController.isLoginAdmin = isLoginAdmin;
		}
		...
		public static void setMyEmail(String myEmail) {
			LoginController.myEmail = myEmail;
		}
			...
			for(User myUser:userList) {
		        ...
		        {	
		        	...
		        	if((myUser.getRole().equals(UserRole.ADMIN.toString()))&&(myUser.getStatute().equals(UserStatut.ACTIVE.toString()))) {
		        		LoginController.setLoginAdmin(true);
		        		LoginController.isLoginAdmin = true;
